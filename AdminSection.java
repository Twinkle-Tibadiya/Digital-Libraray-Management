...
public class AdminSection extends JFrame implements ActionListener{
    ...
    Font f,f1;
     AdminSection()
     {
         ...
         ImageIcon ic=new ImageIcon(ClassLoader.getSystemResource("Library/icon/adminimg1.jpg"));
    ...
    @Override
     public void actionPerformed(ActionEvent e)
     {
         ...
         {
             AddLibrarian.setVisible setVisible = new AddLibrarian.setVisible(true);
         }
         else if(comd.equals("View Librarian"))
         {
             ViewLibrarian.setVisible setVisible = new ViewLibrarian.setVisible(true);
         }
         else if(comd.equals("Delete Librarian"))
         {
             DeleteLibrarian.setVisible setVisible = new DeleteLibrarian.setVisible(true);
         }
